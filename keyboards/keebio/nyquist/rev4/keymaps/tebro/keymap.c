...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [0] = LAYOUT_ortho_5x12(
        ...
        KC_LCTL,  MO(3), KC_LALT,  MO(1),  KC_LGUI,  KC_SPC,  KC_ENT,  MO(2),  KC_RGUI,  KC_DOWN,  KC_UP,    KC_RCTL
    ),
    [1] = LAYOUT_ortho_5x12(
        _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,
        _______,  _______,  KC_UP,    _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,
        KC_DEL,   KC_LEFT,  KC_DOWN,  KC_RGHT,  _______,  _______,  KC_LEFT,  KC_DOWN,  KC_UP,    KC_RGHT,  _______,  _______,
    ...
    [3] = LAYOUT_ortho_5x12(
        ...
        _______,  RGB_RMOD,  RGB_VAI,  RGB_MOD,  _______,   _______,  _______,  KC_INS,   KC_HOME,  KC_PGUP,  _______,  _______,
        _______,  RGB_HUD,   RGB_VAD,  RGB_HUI,  _______,   _______,  _______,  KC_DEL,   KC_END,   KC_PGDN,  _______,  _______,
