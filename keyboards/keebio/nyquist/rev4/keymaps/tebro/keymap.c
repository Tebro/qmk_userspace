...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [3] = LAYOUT_ortho_5x12(
        ...
        _______,  RGB_RMOD,  RGB_VAI,  RGB_MOD,  _______,   _______,  KC_INS,   KC_HOME,  KC_PGUP,  _______,  _______,  _______,
        _______,  RGB_HUD,   RGB_VAD,  RGB_HUI,  _______,   _______,  KC_DEL,   KC_END,   KC_PGDN,  _______,  _______,  _______,
